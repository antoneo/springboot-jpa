...
/*Table structure for table `spi_gnmx` */

DROP TABLE IF EXISTS `spi_gnmx`;

CREATE TABLE `spi_gnmx` (
...
/*Data for the table `spi_gnmx` */

insert  into `spi_gnmx`(`ID_GNMX`,`ID_XTGN`,`NM_GNMX`,`URL_GNMX`,`SEQ_GNMX`,`ICO_GNMX`) values 
...
(6,1,'功能管理',NULL,1,'icon-glass');

/*Table structure for table `spi_xtgn` */

DROP TABLE IF EXISTS `spi_xtgn`;

CREATE TABLE `spi_xtgn` (
...
/*Data for the table `spi_xtgn` */

insert  into `spi_xtgn`(`ID_XTGN`,`NM_XTGN`,`SEQ_XTGN`,`ICO_XTGN`) values 
(1,'系统管理',4,'icon-cog'),
(2,'权限管理',3,'icon-user'),
(3,'数据管理',2,'icon-leaf'),
